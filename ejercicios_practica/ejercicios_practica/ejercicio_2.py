...
if __name__ == '__main__':
    ...
    word = input(str('Ingrese una palabra: '))
    print('cantidad de carácteres del string:', len_string(word))
    ...
    print('La cantidad de carácteres de cada palabra en la lista "palabras" es:', palabras_len)
    print("terminamos")